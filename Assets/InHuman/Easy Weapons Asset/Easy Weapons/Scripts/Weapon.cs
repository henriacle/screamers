...
{
    public GameObject qualquercoisa;
    // Weapon Type
    ...
    public TextMeshProUGUI textoammo;  //texto
	...
	public float burstTimer = 0.0f;					// Timer to keep track of how long the weapon has paused between bursts
	...
	{
        //currentAmmo = ammoCapacity;
        var shot = ammoCapacity - currentAmmo;
